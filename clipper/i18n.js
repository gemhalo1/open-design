...
(function () {
  ...
  const en = {
    ...
    extractBrandKit: 'Extract design system',
    ...
    extractingBrandKit: 'Extracting design system...',
    brandKitAlreadyInLibrary: 'Design system already in library{suffix}.',
    brandKitSaved: 'Design system saved to library{suffix}.',
    ...
    toolbarExtractBrandKit: 'Extract design system',
    ...
    savedBrandKitShort: 'Saved design system',
    ...
    errorBrandKitCaptureFailed: 'design system capture failed',
  ...
  const overrides = {
    id: {
      ...
      extractBrandKit: 'Ekstrak sistem desain', advanced: 'Lanjutan', inlineImages: 'Sematkan gambar',
      onPageBar: 'Bilah di halaman', imageHoverButton: 'Tombol gambar', save: 'Simpan', refreshPage: 'Muat ulang halaman',
      extractingBrandKit: 'Mengekstrak sistem desain...', brandKitSaved: 'Sistem desain disimpan ke library{suffix}.',
      toolbarExtractBrandKit: 'Ekstrak sistem desain', savedBrandKitShort: 'Sistem desain disimpan',
    ...
    de: {
      ...
      extractBrandKit: 'Designsystem extrahieren', advanced: 'Erweitert', inlineImages: 'Bilder einbetten',
      onPageBar: 'Seitenleiste', imageHoverButton: 'Bild-Hover-Button', save: 'Speichern', refreshPage: 'Seite neu laden',
      extractingBrandKit: 'Designsystem wird extrahiert...', brandKitSaved: 'Designsystem in Library gespeichert{suffix}.',
      toolbarExtractBrandKit: 'Designsystem extrahieren', savedBrandKitShort: 'Designsystem gespeichert',
    ...
    'zh-CN': {
      ...
      figmaJson: 'Figma JSON', extractBrandKit: '提取设计系统',
      ...
      extractingBrandKit: '正在提取设计系统...', brandKitAlreadyInLibrary: '设计系统已在素材库中{suffix}。',
      brandKitSaved: '设计系统已保存到素材库{suffix}。', capturingScreenshot: '正在截图...',
      ...
      toolbarExtractBrandKit: '提取设计系统', toolbarDownloadFigma: '下载 Figma 导入 JSON', toolbarCaptureScreenshot: '截图',
      ...
      savedBrandKitShort: '已保存设计系统', savedScreenshot: '已保存截图',
      ...
      errorCaptureTooLarge: '捕获内容过大，请在高级设置中取消“内联图片”后重试', errorBrandKitCaptureFailed: '设计系统捕获失败',
    ...
    'zh-TW': {
      ...
      extractBrandKit: '提取設計系統', advanced: '進階', inlineImages: '內嵌圖片',
      onPageBar: '頁面浮條', imageHoverButton: '圖片懸浮按鈕', save: '儲存', refreshPage: '重新整理頁面',
      extractingBrandKit: '正在提取設計系統...', brandKitSaved: '設計系統已儲存到素材庫{suffix}。',
      toolbarExtractBrandKit: '提取設計系統', savedBrandKitShort: '已儲存設計系統',
    ...
    'pt-BR': {
      ...
      extractBrandKit: 'Extrair sistema de design', advanced: 'Avançado', inlineImages: 'Incorporar imagens',
      onPageBar: 'Barra na página', save: 'Salvar', refreshPage: 'Recarregar página',
      toolbarExtractBrandKit: 'Extrair sistema de design', savedBrandKitShort: 'Sistema de design salvo',
    ...
    'es-ES': {
      ...
      extractBrandKit: 'Extraer sistema de diseño', advanced: 'Avanzado', inlineImages: 'Incrustar imágenes',
      onPageBar: 'Barra en página', save: 'Guardar', refreshPage: 'Recargar página',
      toolbarExtractBrandKit: 'Extraer sistema de diseño', savedBrandKitShort: 'Sistema de diseño guardado',
    ...
    ru: {
      ...
      extractBrandKit: 'Извлечь дизайн-систему', advanced: 'Дополнительно', inlineImages: 'Встроить изображения',
      onPageBar: 'Панель на странице', save: 'Сохранить', refreshPage: 'Обновить страницу',
      toolbarExtractBrandKit: 'Извлечь дизайн-систему', savedBrandKitShort: 'Дизайн-система сохранена',
    ...
    fa: {
      ...
      extractBrandKit: 'استخراج سیستم طراحی', advanced: 'پیشرفته', inlineImages: 'درون‌گذاری تصاویر',
      onPageBar: 'نوار روی صفحه', save: 'ذخیره', refreshPage: 'بازخوانی صفحه',
      toolbarExtractBrandKit: 'استخراج سیستم طراحی', savedBrandKitShort: 'سیستم طراحی ذخیره شد',
    ...
    ar: {
      ...
      extractBrandKit: 'استخراج نظام التصميم', advanced: 'متقدم', inlineImages: 'تضمين الصور',
      onPageBar: 'شريط الصفحة', save: 'حفظ', refreshPage: 'تحديث الصفحة',
      toolbarExtractBrandKit: 'استخراج نظام التصميم', savedBrandKitShort: 'تم حفظ نظام التصميم',
    ...
    ja: {
      ...
      extractBrandKit: 'デザインシステムを抽出', advanced: '詳細', inlineImages: '画像を埋め込む',
      onPageBar: 'ページ上バー', imageHoverButton: '画像ホバーボタン', save: '保存', refreshPage: 'ページを再読み込み',
      extractingBrandKit: 'デザインシステムを抽出中...', brandKitSaved: 'デザインシステムを Library に保存しました{suffix}。',
      toolbarExtractBrandKit: 'デザインシステムを抽出', savedBrandKitShort: 'デザインシステムを保存',
    ...
    ko: {
      ...
      extractBrandKit: '디자인 시스템 추출', advanced: '고급', inlineImages: '이미지 포함',
      onPageBar: '페이지 바', save: '저장', refreshPage: '페이지 새로고침',
      toolbarExtractBrandKit: '디자인 시스템 추출', savedBrandKitShort: '디자인 시스템 저장됨',
