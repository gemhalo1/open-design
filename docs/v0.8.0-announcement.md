...
→ [**Open a bug report**](https://github.com/nexu-io/open-design/issues/new?template=bug-report.yml) or [**a feature request**](https://github.com/nexu-io/open-design/issues/new?template=feature-request.yml) — the team watches [all open issues](https://github.com/nexu-io/open-design/issues).
...
→ [**Join the Open Design preview Discord**](https://discord.gg/RchHB7DQS)
