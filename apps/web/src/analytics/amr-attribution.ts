...
export function attributedAmrUrl(
  ...
  deviceIdOrOptions?: string | null | AttributedAmrUrlOptions,
  maybeOptions: AttributedAmrUrlOptions = {},
): string {
  const deviceId = typeof deviceIdOrOptions === 'string' ? deviceIdOrOptions : null;
  const options = typeof deviceIdOrOptions === 'object' && deviceIdOrOptions !== null
    ? deviceIdOrOptions
    : maybeOptions;
  ...
  if (returnUrl) params.od_return_url = returnUrl;
  try {
