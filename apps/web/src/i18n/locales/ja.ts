...
export const ja: Dict = {
  ...
  'settings.amrActivationHint': 'ブラウザを開いています…開かない場合は、下のリンクからサインインを完了してください。',
  'settings.amrActivationBrowserFailed': 'ブラウザを自動で開けませんでした。下のサインインページを開いて続行してください。',
  'settings.amrActivationOpen': 'サインインページを開く',
  'settings.amrActivationCopyCode': '認証コードをコピー',
  'settings.amrActivationCopy': 'コピー',
  'settings.amrActivationCopied': 'コピーしました',
  ...
  'onboarding.buildArtifacts': 'プロトタイプ·スライド·PDF·履歴書·ダッシュボード·マーケティングカード',
