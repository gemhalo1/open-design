...
export const ja: Dict = {
  ...
  'chat.mode.design.summary': 'ページ、デッキ、ダッシュボード、ファイル、プロトタイプなど具体的なデザイン成果物を作成または変更します。',
  'chat.mode.design.solves': 'Open Design にファイル生成、workspace 更新、brief から成果物への変換を任せたいときに使います。',
  'chat.mode.design.query1': 'この brief から製品ローンチ用ランディングページを作って。',
  'chat.mode.design.query2': 'スピーカーノート付きの10枚の投資家向けデッキを作って。',
  'chat.mode.design.query3': 'この指標に合うダッシュボード UI をデザインして。',
