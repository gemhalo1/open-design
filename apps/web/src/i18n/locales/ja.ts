...
export const ja: Dict = {
  ...
  'chat.amrPreflight.body': '現在、利用可能な CLI や API キーのモデル設定がありません。',
  'chat.amrPreflight.recommend': 'AMR に切り替え:',
  'chat.amrPreflight.chipNoConfig': '設定不要ですぐ使える',
  'chat.amrPreflight.chipOfficialAgents': 'Claude Code・Codex 公式エージェント',
  'chat.amrPreflight.chipPayAsYouGo': '従量課金',
  ...
  'chat.amrPreflight.meta': 'ログインとチャージ後、このタスクは自動的に送信されます。',
  ...
  'settings.testAgentSpawn': '{agentName} を起動できませんでした。インストールとサインインを確認してから、再度テストしてください。',
