...
export const ar: Dict = {
  ...
  'settings.amrActivationHint': 'جارٍ فتح المتصفح… لم يُفتح؟ استخدم الرابط أدناه لإكمال تسجيل الدخول.',
  ...
  'settings.amrActivationCopyCode': 'نسخ رمز التحقق',
  'settings.amrActivationCopy': 'نسخ',
  'settings.amrActivationCopied': 'تم النسخ',
  ...
  'onboarding.buildArtifacts': 'نماذج أولية·شرائح·PDF·سير ذاتية·لوحات معلومات·بطاقات تسويقية',
