...
export const ar: Dict = {
  ...
  'chat.amrPreflight.body': 'لا يوجد حاليًا أي إعداد نموذج قابل للاستخدام عبر CLI أو مفتاح API.',
  'chat.amrPreflight.recommend': 'التبديل إلى AMR:',
  'chat.amrPreflight.chipNoConfig': 'بدون إعداد',
  'chat.amrPreflight.chipOfficialAgents': 'وكلاء Claude Code وCodex الرسميون',
  'chat.amrPreflight.chipPayAsYouGo': 'الدفع حسب الاستخدام',
  ...
  'chat.amrPreflight.meta': 'بعد تسجيل الدخول وشحن الرصيد، تُرسل هذه المهمة تلقائيًا.',
  ...
  'settings.testAgentSpawn': 'تعذّر تشغيل {agentName}. تأكد من تثبيته وتسجيل الدخول، ثم أعد الاختبار.',
