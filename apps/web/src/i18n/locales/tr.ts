...
export const tr: Dict = {
  ...
  'chat.amrPreflight.body': 'Şu anda kullanılabilir bir CLI veya API anahtarı model yapılandırması yok.',
  'chat.amrPreflight.recommend': 'AMR\'ye geç:',
  'chat.amrPreflight.chipNoConfig': 'Kurulum gerekmez',
  'chat.amrPreflight.chipOfficialAgents': 'Resmi Claude Code ve Codex ajanları',
  'chat.amrPreflight.chipPayAsYouGo': 'Kullandıkça öde',
  ...
  'chat.amrPreflight.meta': 'Giriş yapıp bakiye yükledikten sonra bu görev otomatik gönderilir.',
  ...
  'settings.testAgentSpawn': '{agentName} başlatılamadı. Kurulu ve oturum açılmış olduğundan emin olun, ardından yeniden test edin.',
