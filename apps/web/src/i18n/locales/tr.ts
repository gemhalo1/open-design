...
export const tr: Dict = {
  ...
  'settings.onboardingStepConnect': 'Bağlan',
  'settings.onboardingStepDesignSystem': 'Tasarım sistemi',
  'settings.onboardingStepProfile': 'Hakkınızda',
  'settings.onboardingConnectTitle': 'Bir çalışma zamanı seçin',
  'settings.onboardingConnectBody': '',
  'settings.onboardingRecommended': 'Önerilen',
  'settings.onboardingAmrCloudOfficialBadge': 'Resmi',
  'settings.onboardingLocalTitle': 'Yerel kodlama Agent\'ı',
  'settings.onboardingLocalBody': 'Claude Code, Codex, Cursor, Gemini veya OpenCode gibi yüklü bir CLI kullanın.',
  'settings.onboardingLocalAction': 'CLI ayarlarını aç',
  'settings.onboardingCliScanHint': 'Bu genellikle 5-10 saniye sürer.',
  'settings.onboardingByokTitle': 'Kendi anahtarınızı getirin',
  'settings.onboardingByokBody': 'Kendi model sağlayıcı kimlik bilgilerinizi kullanın.',
  'settings.onboardingByokAction': 'BYOK ayarlarını aç',
  'settings.onboardingDesignTitle': 'Tasarım sistemi',
  'settings.onboardingDesignBody': 'Bir kez üretin, her yerde yeniden kullanın.',
  'settings.onboardingDesignIntroGenerateTitle': 'Mevcut çalışmadan üretin',
  'settings.onboardingDesignIntroGenerateBody': 'Tasarım sisteminizi GitHub veya yerel kod depolarından, Figma dosyalarından, görsellerden ve diğer içerik varlıklarından yükleyin.',
  'settings.onboardingDesignIntroReuseTitle': 'Gelecekteki çalışmalarda yeniden kullanın',
  'settings.onboardingDesignIntroReuseBody': 'Gelecekteki prototipler, slaytlar ve diğer içerikler mevcut yazı tiplerinize, boşluklarınıza, logo stilinize ve renk tonunuza başvurabilir.',
  'settings.onboardingDesignIntroSkipTitle': 'Şimdilik isteğe bağlı',
  'settings.onboardingDesignIntroSkipBody': 'Bir tasarım sistemi üretmeden başlamak istiyorsanız bu adımı atlayın.',
  'settings.onboardingGithubTitle': 'GitHub\'dan içe aktar',
  'settings.onboardingGithubBody': 'Bir frontend deposu kullanın.',
  'settings.onboardingUploadTitle': 'Yerel dosyaları yükle',
  'settings.onboardingUploadBody': 'Proje dosyaları, ekran görüntüleri, CSS, dokümanlar veya varlıklar ekleyin.',
  'settings.onboardingPromptTitle': 'İstemden üret',
  'settings.onboardingPromptBody': 'Ürünü veya markayı tanımlayın.',
  'settings.onboardingProfileTitle': 'Hakkınızda',
  'settings.onboardingProfileBody': 'Daha iyi varsayılanlar için isteğe bağlı ayrıntılar.',
  'settings.onboardingRoleLabel': 'Rolünüz',
  'settings.onboardingOrgSizeLabel': 'Kuruluş büyüklüğü',
  'settings.onboardingUseCaseLabel': 'Kullanım senaryosu',
  ...
  'settings.onboardingOrgStartup': 'Startup / KOBİ (11-50)',
  ...
  'settings.onboardingRoleStudent': '🎓 Öğrenci / eğitmen',
  ...
  'settings.onboardingUseAds': '📣 Reklam / sosyal içerik',
  ...
  'settings.onboardingUseEngineering': '🤝 Mühendislik teslimi',
  ...
  'settings.onboardingSourceSocial': '📱 Sosyal medya',
  'settings.onboardingSourceProductHunt': '🅿️ Product Hunt',
  'settings.onboardingSourceCommunity': '💬 Tasarım / AI topluluğu',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 Blog veya bülten',
  'settings.onboardingSourceAiTool': '✨ AI aracı önerisi',
  'settings.onboardingSourceSearch': '🔍 Arama',
  'settings.onboardingSourceEvent': '🎤 Etkinlik veya topluluk',
  'settings.onboardingBack': 'Geri',
  'settings.onboardingContinue': 'Devam et',
  'settings.onboardingFinish': 'Kurulumu bitir',
  'settings.onboardingSkip': 'Şimdilik atla',
  ...
  'workingDirPicker.homeTitle': 'Bu projenin nerede bulunacağını seçin',
  ...
  'home.openExistingProject': 'Mevcut projeyi aç',
  'home.openExistingProjectOpening': 'Açılıyor...',
  'home.chooseFolderSubtitle': 'Diskinizden bir klasör seçin.',
  ...
  'skillPluginCandidate.createForMe': 'Benim için oluştur',
  'skillPluginCandidate.contributeToMain': 'main\'e katkıda bulun',
  'skillPluginCandidate.publishRepo': 'Depoyu yayımla',
  ...
  'chat.designToolbox.tooltip': 'Tasarım araç kutusu / Şansını dene',
  'chat.designToolbox.aria': 'Tasarım araç kutusunu aç',
  'chat.designToolbox.lucky': 'Şansını dene',
  ...
  'workspace.openFile': 'Bir dosya aç',
  'workspace.noFilesMatch': 'Eşleşen dosya yok',
  'workspace.allFiles': 'Tümü',
  'workspace.createNew': 'Yeni oluştur',
  'workspace.tabOpen': 'Aç',
  'workspace.newSideChat': 'Yeni Yan Sohbet',
  'workspace.newSideChatDescription': 'Yeni bir sekmede bağlam duyarlı sohbet açın',
  'workspace.sideChatContextBanner': 'Mevcut konuşmadan entegre edilen bağlam',
  'workspace.sideChatDefaultTitle': 'Yan sohbet',
  'workspace.newTerminal': 'Yeni Terminal',
  'workspace.newTerminalDescription': 'Proje dizininde yeni bir sekmede shell aç',
  ...
  'settings.memoryModelInlineSameAsChat': 'Sohbetle aynı',
  'settings.memoryModelInlineSameAsChatWithModel': 'Sohbetle aynı ({model})',
  'settings.memoryModelInlineSameAsChatWithProvider': 'Sohbetle aynı ({provider})',
