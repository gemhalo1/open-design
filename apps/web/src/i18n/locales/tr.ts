...
export const tr: Dict = {
  ...
  'chat.mode.design.summary': 'Sayfa, deck, dashboard, dosya ve prototip gibi somut tasarım çıktıları oluşturmak veya değiştirmek için.',
  'chat.mode.design.solves': 'Open Design’ın dosya üretmesini, workspace’i güncellemesini veya brief’i teslim edilebilir bir çıktıya dönüştürmesini istediğinizde kullanın.',
  'chat.mode.design.query1': 'Bu brief’ten bir ürün lansmanı landing page’i oluştur.',
  'chat.mode.design.query2': 'Konuşmacı notlarıyla 10 slaytlık yatırımcı deck’i hazırla.',
  'chat.mode.design.query3': 'Bu metrikler için bir dashboard UI tasarla.',
