...
export const pl: Dict = {
  ...
  'settings.amrActivationHint': 'Otwieranie przeglądarki… Nie otworzyła się? Użyj linku poniżej, aby dokończyć logowanie.',
  ...
  'settings.amrActivationCopyCode': 'Kopiuj kod weryfikacyjny',
  'settings.amrActivationCopy': 'Kopiuj',
  'settings.amrActivationCopied': 'Skopiowano',
  ...
  'onboarding.buildArtifacts': 'Prototypy·Slajdy·PDF·CV·Pulpity·Karty marketingowe',
