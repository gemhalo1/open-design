...
export const pl: Dict = {
  ...
  'chat.mode.design.summary': 'Do tworzenia lub zmiany konkretnych wyników designu, takich jak strony, decki, dashboardy, pliki i prototypy.',
  'chat.mode.design.solves': 'Użyj go, gdy Open Design ma wygenerować pliki, zaktualizować workspace lub zamienić brief w gotowy deliverable.',
  'chat.mode.design.query1': 'Stwórz landing page launchu produktu na podstawie tego briefu.',
  'chat.mode.design.query2': 'Przygotuj 10-slajdowy deck inwestorski z notatkami prelegenta.',
  'chat.mode.design.query3': 'Zaprojektuj UI dashboardu dla tych metryk.',
