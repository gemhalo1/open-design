...
export const pl: Dict = {
  ...
  'chat.amrPreflight.body': 'Obecnie brak działającej konfiguracji modelu CLI lub klucza API.',
  'chat.amrPreflight.recommend': 'Przełącz na AMR:',
  'chat.amrPreflight.chipNoConfig': 'Bez konfiguracji',
  'chat.amrPreflight.chipOfficialAgents': 'Oficjalne agenty Claude Code i Codex',
  'chat.amrPreflight.chipPayAsYouGo': 'Płatność za użycie',
  ...
  'chat.amrPreflight.meta': 'Po zalogowaniu i doładowaniu zadanie zostanie wysłane automatycznie.',
  ...
  'settings.testAgentSpawn': 'Nie można uruchomić {agentName}. Sprawdź instalację i logowanie, a następnie przetestuj ponownie.',
