...
export const ptBR: Dict = {
  ...
  'chat.mode.design.summary': 'Para criar ou alterar entregáveis de design concretos como páginas, decks, dashboards, arquivos e protótipos.',
  'chat.mode.design.solves': 'Use quando quiser que o Open Design gere arquivos, atualize o workspace ou transforme um brief em entregável.',
  'chat.mode.design.query1': 'Crie uma landing page de lançamento de produto a partir deste brief.',
  'chat.mode.design.query2': 'Crie um deck para investidores com 10 slides e notas de apresentação.',
  'chat.mode.design.query3': 'Desenhe uma UI de dashboard para estas métricas.',
