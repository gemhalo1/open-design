...
export const it: Dict = {
  ...
  'settings.onboardingStepConnect': 'Connetti',
  'settings.onboardingStepDesignSystem': 'Design system',
  'settings.onboardingStepProfile': 'Informazioni su di te',
  'settings.onboardingConnectTitle': 'Scegli un runtime',
  ...
  'settings.onboardingLocalTitle': 'Agent di coding locale',
  'settings.onboardingLocalBody': 'Usa una CLI installata come Claude Code, Codex, Cursor, Gemini o OpenCode.',
  'settings.onboardingLocalAction': 'Apri le impostazioni CLI',
  'settings.onboardingCliScanHint': 'Di solito richiede 5-10 secondi.',
  'settings.onboardingByokTitle': 'Usa la tua chiave (BYOK)',
  'settings.onboardingByokBody': 'Usa le credenziali del tuo provider di modelli.',
  'settings.onboardingByokAction': 'Apri le impostazioni BYOK',
  'settings.onboardingDesignTitle': 'Design system',
  'settings.onboardingDesignBody': 'Genera una volta, riutilizza ovunque.',
  'settings.onboardingDesignIntroGenerateTitle': 'Genera da lavoro esistente',
  'settings.onboardingDesignIntroGenerateBody': 'Carica il tuo design system da GitHub o repository di codice locali, file Figma, immagini e altri asset di contenuto.',
  'settings.onboardingDesignIntroReuseTitle': 'Riutilizza nei lavori futuri',
  'settings.onboardingDesignIntroReuseBody': 'I prototipi, le slide e altri contenuti futuri possono fare riferimento ai font, alla spaziatura, allo stile del logo e ai toni di colore esistenti.',
  'settings.onboardingDesignIntroSkipTitle': 'Facoltativo per ora',
  'settings.onboardingDesignIntroSkipBody': 'Salta questo passaggio se vuoi iniziare senza generare un design system.',
  'settings.onboardingGithubTitle': 'Importa da GitHub',
  'settings.onboardingGithubBody': 'Usa un repository frontend.',
  'settings.onboardingUploadTitle': 'Carica file locali',
  'settings.onboardingUploadBody': 'Aggiungi file di progetto, screenshot, CSS, documenti o asset.',
  'settings.onboardingPromptTitle': 'Genera da prompt',
  'settings.onboardingPromptBody': 'Descrivi il prodotto o il brand.',
  ...
  'settings.onboardingOrgSizeLabel': 'Dimensione dell\'organizzazione',
  'settings.onboardingUseCaseLabel': 'Caso d\'uso',
  'settings.onboardingSourceLabel': 'Come hai saputo di noi?',
  'settings.onboardingSelectPlaceholder': 'Seleziona uno',
  'settings.onboardingSelectMultiplePlaceholder': 'Seleziona uno o più',
  'settings.onboardingOrgSolo': 'Singolo / personale (1)',
  ...
  'settings.onboardingOrgMidMarket': 'Media impresa (201-1000)',
  ...
  'settings.onboardingRoleEngineer': '💻 Ingegnere',
  ...
  'settings.onboardingUsePrototype': '📱 Prototipo / UI di app',
  ...
  'settings.onboardingUseDeck': '🖥️ Presentazione / deck',
  'settings.onboardingUseMarketing': '📈 Marketing / crescita',
  'settings.onboardingUseEngineering': '🤝 Handoff per l\'ingegneria',
  'settings.onboardingUseAgency': '💼 Agenzia / lavoro per clienti',
  ...
  'settings.onboardingSourceCommunity': '💬 Community di design / AI',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 Blog o newsletter',
  'settings.onboardingSourceAiTool': '✨ Consiglio su strumenti AI',
  'settings.onboardingSourceSearch': '🔍 Ricerca',
  'settings.onboardingSourceEvent': '🎤 Evento o community',
  'settings.onboardingBack': 'Indietro',
  'settings.onboardingContinue': 'Continua',
  'settings.onboardingFinish': 'Completa la configurazione',
  'settings.onboardingSkip': 'Salta per ora',
  ...
  'home.openExistingProject': 'Apri progetto esistente',
  'home.openExistingProjectOpening': 'Apertura...',
  'home.chooseFolderSubtitle': 'Scegli una cartella dal disco.',
