...
export const it: Dict = {
  ...
  'chat.mode.design.summary': 'Per creare o modificare output di design concreti come pagine, deck, dashboard, file e prototipi.',
  'chat.mode.design.solves': 'Usala quando vuoi che Open Design generi file, aggiorni il workspace o trasformi un brief in un deliverable.',
  'chat.mode.design.query1': 'Crea una landing page di lancio prodotto da questo brief.',
  'chat.mode.design.query2': 'Crea un deck investor di 10 slide con note per lo speaker.',
  'chat.mode.design.query3': 'Progetta una UI dashboard per queste metriche.',
