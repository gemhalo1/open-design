...
export const it: Dict = {
  ...
  'settings.amrActivationHint': 'Apertura del browser… Non si apre? Usa il link qui sotto per completare l’accesso.',
  ...
  'settings.amrActivationCopyCode': 'Copia il codice di verifica',
  'settings.amrActivationCopy': 'Copia',
  'settings.amrActivationCopied': 'Copiato',
  ...
  'onboarding.buildArtifacts': 'Prototipi·Slide·PDF·Curriculum·Dashboard·Card di marketing',
