...
export const it: Dict = {
  ...
  'chat.amrPreflight.body': 'Al momento non è disponibile alcuna configurazione di modello CLI o chiave API utilizzabile.',
  'chat.amrPreflight.recommend': 'Passa ad AMR:',
  'chat.amrPreflight.chipNoConfig': 'Nessuna configurazione richiesta',
  'chat.amrPreflight.chipOfficialAgents': 'Agent ufficiali Claude Code e Codex',
  'chat.amrPreflight.chipPayAsYouGo': 'Pagamento a consumo',
  ...
  'chat.amrPreflight.meta': 'Dopo l\'accesso e la ricarica, questa attività viene inviata automaticamente.',
  ...
  'settings.testAgentSpawn': 'Impossibile avviare {agentName}. Verifica che sia installato e che l\'accesso sia attivo, poi riprova il test.',
