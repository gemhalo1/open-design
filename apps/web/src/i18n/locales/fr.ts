...
export const fr: Dict = {
  ...
  'chat.mode.design.summary': 'Pour créer ou modifier des livrables design concrets comme des pages, decks, tableaux de bord, fichiers et prototypes.',
  'chat.mode.design.solves': 'Utilisez-le quand Open Design doit générer des fichiers, mettre à jour le workspace ou transformer un brief en livrable.',
  'chat.mode.design.query1': 'Crée une landing page de lancement produit à partir de ce brief.',
  'chat.mode.design.query2': 'Fais un deck investisseur de 10 slides avec notes de prise de parole.',
  'chat.mode.design.query3': 'Conçois une UI de dashboard pour ces métriques.',
