...
export const de: Dict = {
  ...
  'settings.amrActivationHint': 'Browser wird geöffnet… Nicht geöffnet? Über den Link unten anmelden.',
  ...
  'settings.amrActivationCopyCode': 'Bestätigungscode kopieren',
  'settings.amrActivationCopy': 'Kopieren',
  'settings.amrActivationCopied': 'Kopiert',
  ...
  'onboarding.buildArtifacts': 'Prototypen·Folien·PDFs·Lebensläufe·Dashboards·Marketingkarten',
