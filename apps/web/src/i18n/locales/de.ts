...
export const de: Dict = {
  ...
  'chat.amrPreflight.body': 'Derzeit ist keine nutzbare CLI- oder API-Key-Modellkonfiguration vorhanden.',
  'chat.amrPreflight.recommend': 'Zu AMR wechseln:',
  'chat.amrPreflight.chipNoConfig': 'Keine Einrichtung nötig',
  'chat.amrPreflight.chipOfficialAgents': 'Offizielle Claude Code- & Codex-Agents',
  'chat.amrPreflight.chipPayAsYouGo': 'Abrechnung nach Verbrauch',
  ...
  'chat.amrPreflight.meta': 'Nach Anmeldung und Aufladung wird diese Aufgabe automatisch gesendet.',
  ...
  'settings.testAgentSpawn': '{agentName} konnte nicht gestartet werden. Prüfe Installation und Anmeldung und teste dann erneut.',
