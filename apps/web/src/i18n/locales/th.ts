...
export const th: Dict = {
  ...
  'chat.mode.design.summary': 'สำหรับสร้างหรือแก้ไขผลงานดีไซน์จริง เช่น หน้าเว็บ deck dashboard ไฟล์ และ prototype',
  'chat.mode.design.solves': 'ใช้เมื่ออยากให้ Open Design สร้างไฟล์ อัปเดต workspace หรือเปลี่ยน brief เป็นงานส่งมอบ',
  'chat.mode.design.query1': 'สร้าง landing page เปิดตัวผลิตภัณฑ์จาก brief นี้',
  'chat.mode.design.query2': 'ทำ deck นักลงทุน 10 สไลด์พร้อม speaker notes',
  'chat.mode.design.query3': 'ออกแบบ UI dashboard สำหรับ metrics เหล่านี้',
