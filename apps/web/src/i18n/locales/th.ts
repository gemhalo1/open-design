...
export const th: Dict = {
  ...
  'settings.onboardingStepConnect': 'เชื่อมต่อ',
  'settings.onboardingStepDesignSystem': 'ดีไซน์ซิสเต็ม',
  'settings.onboardingStepProfile': 'เกี่ยวกับคุณ',
  'settings.onboardingConnectTitle': 'เลือกรันไทม์',
  ...
  'settings.onboardingLocalTitle': 'Agent เขียนโค้ดในเครื่อง',
  'settings.onboardingLocalBody': 'ใช้ CLI ที่ติดตั้งไว้ เช่น Claude Code, Codex, Cursor, Gemini หรือ OpenCode',
  'settings.onboardingLocalAction': 'เปิดการตั้งค่า CLI',
  'settings.onboardingCliScanHint': 'โดยปกติใช้เวลา 5-10 วินาที',
  'settings.onboardingByokTitle': 'ใช้คีย์ของคุณเอง',
  'settings.onboardingByokBody': 'ใช้ข้อมูลรับรองของผู้ให้บริการโมเดลของคุณเอง',
  'settings.onboardingByokAction': 'เปิดการตั้งค่า BYOK',
  'settings.onboardingDesignTitle': 'ดีไซน์ซิสเต็ม',
  'settings.onboardingDesignBody': 'สร้างครั้งเดียว นำไปใช้ซ้ำได้ทุกที่',
  'settings.onboardingDesignIntroGenerateTitle': 'สร้างจากงานที่มีอยู่',
  'settings.onboardingDesignIntroGenerateBody': 'อัปโหลดดีไซน์ซิสเต็มของคุณจาก GitHub หรือที่เก็บโค้ดในเครื่อง ไฟล์ Figma รูปภาพ และเนื้อหาอื่น ๆ',
  'settings.onboardingDesignIntroReuseTitle': 'นำไปใช้ซ้ำในงานต่อ ๆ ไป',
  'settings.onboardingDesignIntroReuseBody': 'ต้นแบบ สไลด์ และเนื้อหาอื่น ๆ ในอนาคตสามารถอ้างอิงฟอนต์ การเว้นระยะ สไตล์โลโก้ และโทนสีที่มีอยู่ของคุณได้',
  'settings.onboardingDesignIntroSkipTitle': 'ตอนนี้ยังไม่จำเป็น',
  'settings.onboardingDesignIntroSkipBody': 'ข้ามขั้นตอนนี้ได้ หากคุณต้องการเริ่มต้นโดยยังไม่สร้างดีไซน์ซิสเต็ม',
  'settings.onboardingGithubTitle': 'นำเข้าจาก GitHub',
  'settings.onboardingGithubBody': 'ใช้ที่เก็บโค้ดฝั่งหน้าบ้าน',
  'settings.onboardingUploadTitle': 'อัปโหลดไฟล์ในเครื่อง',
  'settings.onboardingUploadBody': 'เพิ่มไฟล์โปรเจกต์ ภาพหน้าจอ CSS เอกสาร หรือแอสเซต',
  'settings.onboardingPromptTitle': 'สร้างจากพรอมต์',
  'settings.onboardingPromptBody': 'อธิบายผลิตภัณฑ์หรือแบรนด์',
  'settings.onboardingProfileTitle': 'เกี่ยวกับคุณ',
  'settings.onboardingProfileBody': 'รายละเอียดเพิ่มเติม (ไม่บังคับ) เพื่อค่าเริ่มต้นที่ดีกว่า',
  ...
  'settings.onboardingOrgSolo': 'คนเดียว / ส่วนตัว (1)',
  'settings.onboardingOrgTeam': 'ทีมขนาดเล็ก (2-10)',
  'settings.onboardingOrgStartup': 'สตาร์ทอัพ / SMB (11-50)',
  'settings.onboardingOrgGrowth': 'บริษัทที่กำลังเติบโต (51-200)',
  'settings.onboardingOrgMidMarket': 'ตลาดระดับกลาง (201-1000)',
  ...
  'settings.onboardingRoleOps': '⚙️ ปฏิบัติการ',
  ...
  'settings.onboardingUseDesignSystem': '🧩 ระบบการออกแบบ',
  'settings.onboardingUsePrototype': '📱 ต้นแบบ / UI ของแอป',
  'settings.onboardingUseLanding': '🌐 หน้า Landing',
  ...
  'settings.onboardingUseEngineering': '🤝 การส่งมอบให้ฝ่ายวิศวกรรม',
  'settings.onboardingUseAgency': '💼 เอเจนซี / งานลูกค้า',
  'settings.onboardingSourceGithub': '🐙 GitHub',
  'settings.onboardingSourceFriend': '👥 เพื่อนหรือเพื่อนร่วมงาน',
  'settings.onboardingSourceSocial': '📱 โซเชียลมีเดีย',
  'settings.onboardingSourceProductHunt': '🅿️ Product Hunt',
  'settings.onboardingSourceCommunity': '💬 ชุมชนด้านการออกแบบ / AI',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 บล็อกหรือจดหมายข่าว',
  'settings.onboardingSourceAiTool': '✨ คำแนะนำเครื่องมือ AI',
  'settings.onboardingSourceSearch': '🔍 ค้นหา',
  'settings.onboardingSourceEvent': '🎤 อีเวนต์หรือชุมชน',
  'settings.onboardingBack': 'ย้อนกลับ',
  'settings.onboardingContinue': 'ดำเนินการต่อ',
  'settings.onboardingFinish': 'เสร็จสิ้นการตั้งค่า',
  'settings.onboardingSkip': 'ข้ามไปก่อน',
  ...
  'workingDirPicker.homeTitle': 'เลือกตำแหน่งที่จะจัดเก็บโปรเจกต์นี้',
  'workingDirPicker.processing': 'กำลังประมวลผล…',
  'workingDirPicker.select': 'เลือกโฟลเดอร์',
  ...
  'home.openExistingProject': 'เปิดโปรเจกต์ที่มีอยู่',
  'home.openExistingProjectOpening': 'กำลังเปิด...',
  'home.chooseFolderSubtitle': 'เลือกโฟลเดอร์จากดิสก์ของคุณ',
  ...
  'skillPluginCandidate.createForMe': 'สร้างให้ฉัน',
  'skillPluginCandidate.contributeToMain': 'ร่วมสนับสนุนไปยัง main',
  'skillPluginCandidate.publishRepo': 'เผยแพร่ repo',
  'skillPluginCandidate.dismiss': 'ปิด',
  ...
  'chat.designToolbox.tooltip': 'กล่องเครื่องมือออกแบบ / เสี่ยงดวง',
  'chat.designToolbox.aria': 'เปิดกล่องเครื่องมือออกแบบ',
  'chat.designToolbox.lucky': 'เสี่ยงดวง',
  ...
  'workspace.openFile': 'เปิดไฟล์',
  'workspace.noFilesMatch': 'ไม่มีไฟล์ที่ตรงกัน',
  'workspace.allFiles': 'ทั้งหมด',
  'workspace.createNew': 'สร้างใหม่',
  'workspace.tabOpen': 'เปิด',
  'workspace.newSideChat': 'Side Chat ใหม่',
  'workspace.newSideChatDescription': 'เปิดแชทที่รับรู้บริบทในแท็บใหม่',
  'workspace.sideChatContextBanner': 'บริบทที่รวมจากการสนทนาปัจจุบัน',
  'workspace.sideChatDefaultTitle': 'แชทด้านข้าง',
  'workspace.newTerminal': 'เทอร์มินัลใหม่',
  'workspace.newTerminalDescription': 'เปิด shell ในไดเรกทอรีโปรเจกต์ในแท็บใหม่',
  'workspace.newBrowser': 'เบราว์เซอร์ใหม่',
  'workspace.newBrowserDescription': 'เปิดแท็บเบราว์เซอร์ในตัวสำหรับเว็บไซต์อ้างอิงและการค้นคว้าด้านดีไซน์',
  ...
  'settings.designSystemsCraft': 'ฝีมือ',
