...
export const zhTW: Dict = {
  ...
  'settings.onboardingAmrCloudAuthorizeAction': '授權 AMR',
  ...
  'settings.azureBaseUrlHint': '請在 Azure 入口網站 → 您的資源 → 端點中找到此項。',
  'settings.azureDeploymentModel': '部署名稱',
  'settings.azureCustomDeploymentName': '自訂部署名稱',
  ...
  'settings.cliEnvClaudeBaseUrl': 'Claude 代理 Base URL',
  'settings.cliEnvClaudeApiKey': 'Claude 代理 API key',
  'settings.cliEnvCodexHome': 'Codex home',
  'settings.cliEnvCodexBin': 'Codex 可執行檔路徑',
  'settings.cliEnvCodexBaseUrl': 'Codex/OpenAI 代理 Base URL',
  'settings.cliEnvCodexApiKey': 'Codex/OpenAI 代理 API key',
  ...
  'home.openExistingProject': '開啟現有專案',
  'home.openExistingProjectOpening': '正在開啟...',
  'home.chooseFolderSubtitle': '從磁碟選擇一個資料夾。',
