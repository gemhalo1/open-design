...
export const zhTW: Dict = {
  ...
  'chat.mode.design.summary': '適合建立或修改具體設計產物，例如網頁、Deck、資料看板、檔案和原型。',
  'chat.mode.design.solves': '當你希望 Open Design 產生檔案、更新 workspace，或把需求變成可交付結果時使用。',
  'chat.mode.design.query1': '根據這段需求做一個產品發布落地頁。',
  'chat.mode.design.query2': '做一份 10 頁投資人 Deck，並附上講稿備註。',
  'chat.mode.design.query3': '基於這些指標設計一個資料看板 UI。',
