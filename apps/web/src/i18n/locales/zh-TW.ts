...
export const zhTW: Dict = {
  ...
  'settings.memoryDistillTitle': '從註解中提煉規則',
  'settings.memoryDistillHint': '把你在交付物上留下的註解（每行一條）貼到這裡，提煉出可重複使用、可驗證的規則。審閱後保留你需要的。',
  'settings.memoryDistillPlaceholder': '每行一條註解……',
  'settings.memoryDistillRun': '提煉規則',
  'settings.memoryDistillRunning': '提煉中……',
  'settings.memoryDistillEmpty': '這些註解沒有提煉出規則建議。',
  'settings.memoryVerifyTitle': '自我驗證強制執行',
  'settings.memoryVerifyHint': '守護程序最近依據你的生效規則檢查過的回合。',
  'settings.memoryVerifyEmpty': '尚無驗證記錄。',
