...
export const zhTW: Dict = {
  ...
  'chat.amrCard.switchBody': '可切換到 Open Design 官方 AMR 模型服務，無需設定 API Key。完成登入與儲值後，將自動重試目前任務。',
  'chat.amrCard.chipOfficial': '官方代管',
  'chat.amrCard.chipNoKey': '無需 API Key',
  'chat.amrCard.chipAutoRetry': '登入後自動重試',
  'chat.amrCard.switchCta': '切換到 AMR 並重試',
  'chat.amrPreflight.title': '目前還沒有可用的模型能力',
  'chat.amrPreflight.body': '尚未設定可用的 CLI 或模型。',
  'chat.amrPreflight.recommend': '推薦改用 AMR：',
  'chat.amrPreflight.chipNoConfig': '免設定即用',
  'chat.amrPreflight.chipOfficialAgents': 'Claude Code、Codex 官方代理',
  'chat.amrPreflight.chipPayAsYouGo': '按量計費',
  'chat.amrPreflight.inlineTitle': '目前模型尚未設定',
  'chat.amrPreflight.detailByokIncomplete': 'BYOK 缺少 API Key、Base URL 或模型。',
  'chat.amrPreflight.detailByokMissing': 'BYOK 缺少 {fields}。',
  'chat.amrPreflight.detailAgentUnselected': '尚未選擇本地 CLI 模型。',
  'chat.amrPreflight.detailAgentUnavailable': '目前選擇的本地 CLI 不可用。',
  'chat.amrPreflight.detailAgentAuthMissing': '目前選擇的本地 CLI 尚未登入。',
  'chat.amrPreflight.detailModelUnavailable': '目前選擇的模型不在該 CLI 的可用清單中。',
  'chat.amrPreflight.useAmrCta': '使用 AMR 繼續',
  'chat.amrPreflight.useAmrNowCta': '使用 AMR',
  'chat.amrPreflight.configureCta': '去設定模型',
  'chat.amrPreflight.closeAria': '關閉 AMR 引導',
  'chat.amrPreflight.meta': '登入並儲值後，目前任務會自動傳送。',
  'chat.amrPreflight.signInUseAmrCta': '登入並使用 AMR',
  'chat.amrPreflight.pendingNotice': '登入 AMR 後將自動傳送目前任務。',
  'settings.amrRescueSeeAbove': '建議改用上方的 {amr}，無需設定 CLI 或 API Key。',
  'settings.amrRescueLinkLabel': 'Open Design AMR',
  'chat.amrError.authMessage': 'AMR 帳號尚未登入。完成登入後將自動重試目前任務。',
  'chat.amrError.balanceMessage': 'AMR 帳戶餘額不足。儲值後即可繼續執行目前任務。',
  'chat.amrError.authorizeCta': '登入並重試',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': '登入 AMR',
  'settings.onboardingAmrCloudAuthorizedAction': '已登入',
  ...
  'settings.testAgentSpawn': '無法啟動 {agentName}。請確認它已安裝並完成登入，然後重新測試。',
  ...
  'settings.amrAuthorize': '登入',
  'settings.amrBenefitOfficial': '官方推薦',
  'settings.amrBenefitLowerPrice': '免部署即用',
  'settings.amrBenefitManyModels': '多種模型',
  'settings.amrPromoBonus': '限時儲值贈 100%',
  'settings.amrSignInToContinue': '登入後繼續',
