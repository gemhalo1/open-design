...
export const zhTW: Dict = {
  ...
  'settings.amrActivationHint': '正在開啟瀏覽器…沒有彈出?用下面的連結完成登入。',
  'settings.amrActivationBrowserFailed': '無法自動開啟瀏覽器,請開啟下方的登入頁繼續。',
  'settings.amrActivationOpen': '開啟登入頁',
  'settings.amrActivationCopyCode': '複製驗證碼',
  'settings.amrActivationCopy': '複製',
  'settings.amrActivationCopied': '已複製',
  ...
  'homeHero.openAsProject': '以專案開啟',
  'homeHero.openAsProjectHint': '略過填寫——直接以此範例開啟可編輯的專案。',
  ...
  'onboarding.buildArtifacts': '原型·簡報·PDF·履歷·數據儀表板·行銷卡片',
