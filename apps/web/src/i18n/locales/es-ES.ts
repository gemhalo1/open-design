...
export const esES: Dict = {
  ...
  'chat.mode.design.summary': 'Para crear o cambiar resultados de diseño concretos como páginas, decks, paneles, archivos y prototipos.',
  'chat.mode.design.solves': 'Úsalo cuando quieras que Open Design genere archivos, actualice el workspace o convierta un brief en un entregable.',
  'chat.mode.design.query1': 'Crea una landing page de lanzamiento de producto a partir de este brief.',
  'chat.mode.design.query2': 'Haz un deck para inversores de 10 diapositivas con notas de presentación.',
  'chat.mode.design.query3': 'Diseña una UI de dashboard para estas métricas.',
