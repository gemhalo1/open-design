...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Open Design\'s official AMR model service — no API key setup needed. After you sign in and top up, this run retries automatically.',
  ...
  'chat.amrPreflight.title': 'No model capability is available yet',
  'chat.amrPreflight.body': 'No usable CLI or API key model setup right now.',
  'chat.amrPreflight.recommend': 'Switch to AMR:',
  'chat.amrPreflight.chipNoConfig': 'No setup needed',
  'chat.amrPreflight.chipOfficialAgents': 'Official Claude Code & Codex agents',
  'chat.amrPreflight.chipPayAsYouGo': 'Pay as you go',
  'chat.amrPreflight.inlineTitle': 'Current model is not configured',
  'chat.amrPreflight.detailByokIncomplete': 'BYOK is missing an API key, base URL, or model.',
  'chat.amrPreflight.detailByokMissing': 'BYOK is missing {fields}.',
  'chat.amrPreflight.detailAgentUnselected': 'No local CLI agent is selected yet.',
  'chat.amrPreflight.detailAgentUnavailable': 'The selected local CLI is not available.',
  'chat.amrPreflight.detailAgentAuthMissing': 'The selected local CLI is not signed in.',
  'chat.amrPreflight.detailModelUnavailable': 'The selected model is not available for the current CLI.',
  'chat.amrPreflight.useAmrCta': 'Use AMR to continue',
  'chat.amrPreflight.useAmrNowCta': 'Use AMR',
  'chat.amrPreflight.configureCta': 'Configure model',
  'chat.amrPreflight.closeAria': 'Close AMR guidance',
  'chat.amrPreflight.meta': 'After sign-in and top-up, this task is sent automatically.',
  'chat.amrPreflight.signInUseAmrCta': 'Sign in & use AMR',
  'chat.amrPreflight.pendingNotice': 'This task will be sent automatically once you sign in to AMR.',
  'settings.amrRescueSeeAbove': 'Try {amr} above instead — no CLI or API key setup needed.',
  'settings.amrRescueLinkLabel': 'Open Design AMR',
  'chat.amrError.authMessage': 'Your AMR account isn\'t signed in yet. Sign in and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your AMR balance has run out. Top up to keep this run going.',
  'chat.amrError.authorizeCta': 'Sign in & retry',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'Sign in to AMR',
  'settings.onboardingAmrCloudAuthorizedAction': 'Signed in',
  ...
  'settings.testAgentSpawn': 'Could not start {agentName}. Check that it is installed and signed in, then test again.',
  ...
  'settings.amrAuthorize': 'Sign in',
  'settings.amrBenefitOfficial': 'Officially recommended',
  'settings.amrBenefitLowerPrice': 'No setup needed',
  'settings.amrBenefitManyModels': 'Multiple models',
