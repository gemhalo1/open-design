...
export const en: Dict = {
  ...
  'chat.mode.design.summary': 'For creating or changing concrete design outputs such as pages, decks, dashboards, files, and prototypes.',
  'chat.mode.design.solves': 'Use it when you want Open Design to generate files, update the workspace, or turn a brief into a deliverable.',
  'chat.mode.design.query1': 'Create a product launch landing page from this brief.',
  'chat.mode.design.query2': 'Make a 10-slide investor deck with speaker notes.',
  'chat.mode.design.query3': 'Design a dashboard UI for these metrics.',
