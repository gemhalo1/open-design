...
export const en: Dict = {
  ...
  'settings.amrActivationHint': 'Opening your browser… Didn’t open? Use the link below to finish signing in.',
  ...
  'settings.amrActivationCopyCode': 'Copy verification code',
  'settings.amrActivationCopy': 'Copy',
  'settings.amrActivationCopied': 'Copied',
  ...
  'onboarding.buildArtifacts': 'Prototypes·Slides·PDFs·Résumés·Dashboards·Marketing cards',
