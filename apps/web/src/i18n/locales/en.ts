...
export const en: Dict = {
  ...
  'brandPicker.heading': 'Or start from a brand you love',
  'brandPicker.subtext': 'Click any brand to extract its kit straight from its website.',
  'brandPicker.quickPicksLabel': 'Popular brands',
