...
export const en: Dict = {
  ...
  'homeHero.chip.createBrandKit': 'Create Brand Kit',
  ...
  'homeHero.chip.createBrandKitHint': 'Extract a brand kit from a website, then apply it in any chat.',
  ...
  'settings.memoryDistillTitle': 'Distill rules from notes',
  'settings.memoryDistillHint': 'Paste the notes you left on a delivered artifact (one per line) to distil reusable, checkable rules. Review and Keep the ones you want.',
  'settings.memoryDistillPlaceholder': 'One annotation note per line…',
  'settings.memoryDistillRun': 'Distill rules',
  'settings.memoryDistillRunning': 'Distilling…',
  'settings.memoryDistillEmpty': 'No rule proposals from these notes.',
  'settings.memoryVerifyTitle': 'Self-verify enforcement',
  'settings.memoryVerifyHint': 'Recent turns the daemon checked against your active rules.',
  'settings.memoryVerifyEmpty': 'No verification records yet.',
  'settings.memoryVerifyClear': 'Clear',
