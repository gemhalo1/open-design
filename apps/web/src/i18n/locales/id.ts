...
export const id: Dict = {
  ...
  'settings.amrActivationHint': 'Membuka browser… Tidak terbuka? Gunakan tautan di bawah untuk menyelesaikan proses masuk.',
  ...
  'settings.amrActivationCopyCode': 'Salin kode verifikasi',
  'settings.amrActivationCopy': 'Salin',
  'settings.amrActivationCopied': 'Disalin',
  ...
  'onboarding.buildArtifacts': 'Prototipe·Slide·PDF·Resume·Dashboard·Kartu marketing',
