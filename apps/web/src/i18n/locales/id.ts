...
export const id: Dict = {
  ...
  'chat.mode.design.summary': 'Untuk membuat atau mengubah output desain konkret seperti halaman, deck, dashboard, file, dan prototipe.',
  'chat.mode.design.solves': 'Gunakan saat Anda ingin Open Design membuat file, memperbarui workspace, atau mengubah brief menjadi deliverable.',
  'chat.mode.design.query1': 'Buat landing page peluncuran produk dari brief ini.',
  'chat.mode.design.query2': 'Buat deck investor 10 slide dengan catatan pembicara.',
  'chat.mode.design.query3': 'Desain UI dashboard untuk metrik ini.',
