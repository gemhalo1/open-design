...
export const id: Dict = {
  ...
  'chat.amrPreflight.body': 'Saat ini tidak ada konfigurasi model CLI atau API key yang dapat digunakan.',
  'chat.amrPreflight.recommend': 'Beralih ke AMR:',
  'chat.amrPreflight.chipNoConfig': 'Tanpa konfigurasi',
  'chat.amrPreflight.chipOfficialAgents': 'Agen resmi Claude Code & Codex',
  'chat.amrPreflight.chipPayAsYouGo': 'Bayar sesuai pemakaian',
  ...
  'chat.amrPreflight.meta': 'Setelah masuk dan top-up, tugas ini akan dikirim secara otomatis.',
  ...
  'settings.testAgentSpawn': 'Tidak dapat memulai {agentName}. Pastikan sudah terpasang dan masuk, lalu uji lagi.',
