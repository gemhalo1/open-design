...
export const ru: Dict = {
  ...
  'settings.onboardingStepConnect': 'Подключить',
  'settings.onboardingStepDesignSystem': 'Дизайн-система',
  'settings.onboardingStepProfile': 'О вас',
  'settings.onboardingConnectTitle': 'Выберите среду выполнения',
  ...
  'settings.onboardingLocalTitle': 'Локальный Agent для кодинга',
  ...
  'settings.onboardingByokTitle': 'Используйте свой ключ',
  'settings.onboardingByokBody': 'Используйте учётные данные собственного провайдера моделей.',
  'settings.onboardingByokAction': 'Открыть настройки BYOK',
  'settings.onboardingDesignTitle': 'Дизайн-система',
  'settings.onboardingDesignBody': 'Сгенерируйте один раз — используйте везде.',
  'settings.onboardingDesignIntroGenerateTitle': 'Сгенерировать из существующей работы',
  'settings.onboardingDesignIntroGenerateBody': 'Загрузите свою дизайн-систему из GitHub или локальных репозиториев кода, файлов Figma, изображений и других ресурсов контента.',
  'settings.onboardingDesignIntroReuseTitle': 'Повторное использование в будущих работах',
  'settings.onboardingDesignIntroReuseBody': 'Будущие прототипы, слайды и другой контент смогут использовать ваши существующие шрифты, отступы, стиль логотипа и цветовую гамму.',
  ...
  'settings.onboardingGithubTitle': 'Импортировать из GitHub',
  'settings.onboardingGithubBody': 'Используйте фронтенд-репозиторий.',
  'settings.onboardingUploadTitle': 'Загрузить локальные файлы',
  'settings.onboardingUploadBody': 'Добавьте файлы проекта, скриншоты, CSS, документы или ресурсы.',
  'settings.onboardingPromptTitle': 'Сгенерировать из запроса',
  'settings.onboardingPromptBody': 'Опишите продукт или бренд.',
  'settings.onboardingProfileTitle': 'О вас',
  'settings.onboardingProfileBody': 'Необязательные детали для лучших параметров по умолчанию.',
  ...
  'settings.onboardingSelectPlaceholder': 'Выберите один вариант',
  'settings.onboardingSelectMultiplePlaceholder': 'Выберите один или несколько',
  'settings.onboardingOrgSolo': 'Один / личное использование (1)',
  'settings.onboardingOrgTeam': 'Небольшая команда (2-10)',
  'settings.onboardingOrgStartup': 'Стартап / малый бизнес (11-50)',
  'settings.onboardingOrgGrowth': 'Растущая компания (51-200)',
  'settings.onboardingOrgMidMarket': 'Средний бизнес (201-1000)',
  'settings.onboardingOrgEnterprise': 'Крупное предприятие (1000+)',
  ...
  'settings.onboardingRoleFounder': '🚀 Основатель / руководитель',
  'settings.onboardingRoleStudent': '🎓 Студент / преподаватель',
  'settings.onboardingRoleOther': '✨ Другое',
  'settings.onboardingUseProduct': '🎨 Дизайн продукта',
  'settings.onboardingUseDesignSystem': '🧩 Дизайн-система',
  'settings.onboardingUsePrototype': '📱 Прототип / интерфейс приложения',
  ...
  'settings.onboardingUseAgency': '💼 Агентство / работа с клиентами',
  'settings.onboardingSourceGithub': '🐙 GitHub',
  'settings.onboardingSourceFriend': '👥 Друг или коллега',
  'settings.onboardingSourceSocial': '📱 Социальные сети',
  'settings.onboardingSourceProductHunt': '🅿️ Product Hunt',
  'settings.onboardingSourceCommunity': '💬 Сообщество дизайна / ИИ',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 Блог или рассылка',
  'settings.onboardingSourceAiTool': '✨ Рекомендация ИИ-инструмента',
  'settings.onboardingSourceSearch': '🔍 Поиск',
  'settings.onboardingSourceEvent': '🎤 Мероприятие или сообщество',
  'settings.onboardingBack': 'Назад',
  'settings.onboardingContinue': 'Продолжить',
  'settings.onboardingFinish': 'Завершить настройку',
  'settings.onboardingSkip': 'Пропустить пока',
  ...
  'workingDirPicker.homeTitle': 'Выберите, где будет размещён этот проект',
  'workingDirPicker.processing': 'Обработка…',
  'workingDirPicker.select': 'Выбрать папку',
  ...
  'home.openExistingProject': 'Открыть существующий проект',
  'home.openExistingProjectOpening': 'Открываем...',
  'home.chooseFolderSubtitle': 'Выберите папку на диске.',
  ...
  'settings.memoryModelInlineHintCli': 'Необязательно. Использует выбранный Local CLI, когда поддерживается; выбирайте модель только для переопределения значения по умолчанию.',
  'settings.memoryModelInlineHintCliConstrained': 'Необязательно. Использует выбранный Local CLI, когда поддерживается; {provider} — только резервное семейство провайдеров.',
