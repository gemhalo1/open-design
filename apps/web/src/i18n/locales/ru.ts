...
export const ru: Dict = {
  ...
  'chat.amrPreflight.body': 'Сейчас нет доступной конфигурации модели через CLI или API-ключ.',
  'chat.amrPreflight.recommend': 'Перейти на AMR:',
  'chat.amrPreflight.chipNoConfig': 'Без настройки',
  'chat.amrPreflight.chipOfficialAgents': 'Официальные агенты Claude Code и Codex',
  'chat.amrPreflight.chipPayAsYouGo': 'Оплата по использованию',
  ...
  'chat.amrPreflight.meta': 'После входа и пополнения задача будет отправлена автоматически.',
  ...
  'settings.testAgentSpawn': 'Не удалось запустить {agentName}. Убедитесь, что он установлен и выполнен вход, затем повторите тест.',
