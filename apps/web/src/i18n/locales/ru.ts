...
export const ru: Dict = {
  ...
  'chat.mode.design.summary': 'Для создания или изменения конкретных дизайн-результатов: страниц, деков, дашбордов, файлов и прототипов.',
  'chat.mode.design.solves': 'Используйте его, когда Open Design должен сгенерировать файлы, обновить workspace или превратить бриф в готовый результат.',
  'chat.mode.design.query1': 'Создай лендинг запуска продукта по этому брифу.',
  'chat.mode.design.query2': 'Сделай инвестиционный deck на 10 слайдов с заметками спикера.',
  'chat.mode.design.query3': 'Спроектируй UI дашборда для этих метрик.',
