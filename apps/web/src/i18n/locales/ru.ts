...
export const ru: Dict = {
  ...
  'settings.amrActivationHint': 'Открываем браузер… Не открылся? Используйте ссылку ниже, чтобы завершить вход.',
  ...
  'settings.amrActivationCopyCode': 'Скопировать код подтверждения',
  'settings.amrActivationCopy': 'Копировать',
  'settings.amrActivationCopied': 'Скопировано',
  ...
  'onboarding.buildArtifacts': 'Прототипы·Слайды·PDF·Резюме·Дашборды·Маркетинговые карточки',
