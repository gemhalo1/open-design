...
export const zhCN: Dict = {
  ...
  'settings.amrActivationHint': '正在打开浏览器…没有弹出?用下面的链接完成登录。',
  'settings.amrActivationBrowserFailed': '没能自动打开浏览器,请打开下面的登录页继续。',
  'settings.amrActivationOpen': '打开登录页',
  'settings.amrActivationCopyCode': '复制验证码',
  'settings.amrActivationCopy': '复制',
  'settings.amrActivationCopied': '已复制',
  ...
  'homeHero.openAsProject': '作为项目打开',
  'homeHero.openAsProjectHint': '跳过填写——直接基于该示例打开可编辑的项目。',
  ...
  'onboarding.buildArtifacts': '原型·幻灯片·PDF·简历·数据看板·营销卡片',
