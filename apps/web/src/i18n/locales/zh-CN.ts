...
export const zhCN: Dict = {
  ...
  'homeHero.chip.createBrandKit': '创建品牌套件',
  ...
  'homeHero.chip.createBrandKitHint': '从网站提取一个品牌套件，然后在任意对话中应用它。',
  ...
  'settings.memoryDistillTitle': '从批注中提炼规则',
  'settings.memoryDistillHint': '把你在交付物上留下的批注（每行一条）粘贴到这里，提炼出可复用、可校验的规则。审阅后保留你需要的。',
  'settings.memoryDistillPlaceholder': '每行一条批注……',
  'settings.memoryDistillRun': '提炼规则',
  'settings.memoryDistillRunning': '提炼中……',
  'settings.memoryDistillEmpty': '这些批注没有提炼出规则建议。',
  'settings.memoryVerifyTitle': '自检强制执行',
  'settings.memoryVerifyHint': '守护进程最近依据你的生效规则检查过的回合。',
  'settings.memoryVerifyEmpty': '暂无校验记录。',
  'settings.memoryVerifyClear': '清空',
  ...
  'brand.librarySubtitle': '把你的品牌套件教给 Open Design——从网站提取一个品牌套件，然后在任意对话中应用它。',
  'brand.newBrand': '新建品牌套件',
  'brand.searchPlaceholder': '搜索你的品牌套件…',
  'brand.empty': '还没有品牌套件。从一个网站提取一个品牌套件即可开始。',
  ...
  'brandDetail.deleteConfirm': '删除"{name}"？这会移除该品牌及其设计系统。',
  ...
  'onboarding.brandTitle': '提取你的品牌套件',
  'onboarding.brandSubtitle': '粘贴品牌网站，我们会把品牌线索转成后续可复用的品牌套件。',
  'onboarding.brandSkip': '暂时跳过',
  'onboarding.brandDone': '品牌套件已提取',
};
