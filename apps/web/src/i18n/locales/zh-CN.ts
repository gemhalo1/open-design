...
export const zhCN: Dict = {
  ...
  'chat.mode.design.summary': '适合创建或修改具体设计产物，比如网页、Deck、数据看板、文件和原型。',
  'chat.mode.design.solves': '当你希望 Open Design 生成文件、更新工作区，或把需求变成可交付结果时使用。',
  'chat.mode.design.query1': '根据这段需求做一个产品发布落地页。',
  'chat.mode.design.query2': '做一份 10 页投资人 Deck，并附上讲稿备注。',
  'chat.mode.design.query3': '基于这些指标设计一个数据看板 UI。',
