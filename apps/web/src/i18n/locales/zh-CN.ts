...
export const zhCN: Dict = {
  ...
  'homeHero.chip.socialCard': '社媒卡片',
  'homeHero.chip.diagram': '画图',
  ...
  'homeHero.chip.socialCardDesc': '可分享的图文卡片',
  'homeHero.chip.diagramDesc': '架构图与流程图',
  ...
  'homeHero.chip.socialCardNext': '打开对话,生成适配平台的社媒卡片、封面和轮播图。',
  'homeHero.chip.diagramNext': '打开对话,绘制可编辑的技术图、架构图和流程图。',
