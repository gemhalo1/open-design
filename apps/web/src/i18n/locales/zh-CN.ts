...
export const zhCN: Dict = {
  ...
  'chat.amrCard.switchBody': '可切换到 Open Design 官方 AMR 模型服务，无需配置 API Key。完成登录和充值后，将自动重试当前任务。',
  'chat.amrCard.chipOfficial': '官方托管',
  'chat.amrCard.chipNoKey': '无需 API Key',
  'chat.amrCard.chipAutoRetry': '登录后自动重试',
  'chat.amrCard.switchCta': '切换到 AMR 并重试',
  'chat.amrPreflight.title': '当前还没有可用的模型能力',
  'chat.amrPreflight.body': '尚未配置可用的 CLI 或模型。',
  'chat.amrPreflight.recommend': '推荐改用 AMR：',
  'chat.amrPreflight.chipNoConfig': '免配置即用',
  'chat.amrPreflight.chipOfficialAgents': 'Claude Code、Codex 官方代理',
  'chat.amrPreflight.chipPayAsYouGo': '按量计费',
  'chat.amrPreflight.inlineTitle': '当前模型未配置',
  'chat.amrPreflight.detailByokIncomplete': 'BYOK 缺少 API Key、Base URL 或模型。',
  'chat.amrPreflight.detailByokMissing': 'BYOK 缺少 {fields}。',
  'chat.amrPreflight.detailAgentUnselected': '还没有选择本地 CLI 模型。',
  'chat.amrPreflight.detailAgentUnavailable': '当前选择的本地 CLI 不可用。',
  'chat.amrPreflight.detailAgentAuthMissing': '当前选择的本地 CLI 尚未登录。',
  'chat.amrPreflight.detailModelUnavailable': '当前选择的模型不在该 CLI 的可用列表中。',
  'chat.amrPreflight.useAmrCta': '使用 AMR 继续',
  'chat.amrPreflight.useAmrNowCta': '使用 AMR',
  'chat.amrPreflight.configureCta': '去配置模型',
  'chat.amrPreflight.closeAria': '关闭 AMR 引导',
  'chat.amrPreflight.meta': '登录并充值后，当前任务会自动发送。',
  'chat.amrPreflight.signInUseAmrCta': '登录并使用 AMR',
  'chat.amrPreflight.pendingNotice': '登录 AMR 后将自动发送当前任务。',
  'settings.amrRescueSeeAbove': '推荐改用上方的 {amr}，无需配置 CLI 或 API Key。',
  'settings.amrRescueLinkLabel': 'Open Design AMR',
  'chat.amrError.authMessage': 'AMR 账号尚未登录。完成登录后将自动重试当前任务。',
  'chat.amrError.balanceMessage': 'AMR 账户余额不足。充值后可继续运行当前任务。',
  'chat.amrError.authorizeCta': '登录并重试',
  ...
  'settings.onboardingExecutionBody': 'Open Design 首次使用推荐 AMR：官方托管模型能力，无需安装 CLI 或配置 API Key。登录并充值后，就可以直接用 Claude、Codex 等模型继续当前任务。',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': '登录 AMR',
  'settings.onboardingAmrCloudAuthorizedAction': '已登录',
  ...
  'settings.testAgentSpawn': '无法启动 {agentName}。请确认它已安装并完成登录，然后重新测试。',
  ...
  'settings.amrSignInToContinue': '登录后继续',
