...
export const hu: Dict = {
  ...
  'settings.amrActivationHint': 'A böngésző megnyitása… Nem nyílt meg? Használja az alábbi hivatkozást a bejelentkezés befejezéséhez.',
  ...
  'settings.amrActivationCopyCode': 'Ellenőrző kód másolása',
  'settings.amrActivationCopy': 'Másolás',
  'settings.amrActivationCopied': 'Másolva',
  ...
  'homeHero.openAsProject': 'Open as project',
  'homeHero.openAsProjectHint': 'Skip the brief — open an editable project seeded from this example.',
  ...
  'onboarding.buildArtifacts': 'Prototípusok·Diák·PDF-ek·Önéletrajzok·Irányítópultok·Marketingkártyák',
