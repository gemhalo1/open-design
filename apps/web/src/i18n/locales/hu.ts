...
export const hu: Dict = {
  ...
  'chat.mode.design.summary': 'Konkrét design kimenetek, például oldalak, deckek, dashboardok, fájlok és prototípusok létrehozásához vagy módosításához.',
  'chat.mode.design.solves': 'Akkor használd, ha az Open Designnak fájlokat kell generálnia, frissítenie a workspace-t, vagy briefből kész eredményt kell csinálnia.',
  'chat.mode.design.query1': 'Készíts termékbevezető landing page-et ebből a briefből.',
  'chat.mode.design.query2': 'Készíts 10 diás befektetői decket előadói jegyzetekkel.',
  'chat.mode.design.query3': 'Tervezz dashboard UI-t ezekhez a metrikákhoz.',
