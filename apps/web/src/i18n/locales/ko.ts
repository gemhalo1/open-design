...
export const ko: Dict = {
  ...
  'chat.mode.design.summary': '페이지, 덱, 대시보드, 파일, 프로토타입처럼 구체적인 디자인 산출물을 만들거나 변경합니다.',
  'chat.mode.design.solves': 'Open Design이 파일을 생성하고 workspace를 업데이트하거나 brief를 deliverable로 바꿔야 할 때 사용합니다.',
  'chat.mode.design.query1': '이 brief로 제품 출시 랜딩 페이지를 만들어줘.',
  'chat.mode.design.query2': '발표자 노트가 있는 10장짜리 투자자 덱을 만들어줘.',
  'chat.mode.design.query3': '이 지표를 위한 대시보드 UI를 디자인해줘.',
