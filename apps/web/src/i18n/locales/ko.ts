...
export const ko: Dict = {
  ...
  'settings.amrActivationHint': '브라우저를 여는 중입니다… 열리지 않나요? 아래 링크로 로그인을 완료하세요.',
  'settings.amrActivationBrowserFailed': '브라우저를 자동으로 열지 못했습니다. 아래 로그인 페이지를 열어 계속하세요.',
  'settings.amrActivationOpen': '로그인 페이지 열기',
  'settings.amrActivationCopyCode': '인증 코드 복사',
  'settings.amrActivationCopy': '복사',
  'settings.amrActivationCopied': '복사됨',
  ...
  'onboarding.buildArtifacts': '프로토타입·슬라이드·PDF·이력서·대시보드·마케팅 카드',
