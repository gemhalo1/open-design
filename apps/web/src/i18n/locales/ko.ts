...
export const ko: Dict = {
  ...
  'settings.onboardingStepConnect': '연결',
  'settings.onboardingStepDesignSystem': '디자인 시스템',
  'settings.onboardingStepProfile': '사용자 정보',
  'settings.onboardingConnectTitle': '런타임 선택',
  'settings.onboardingConnectBody': '',
  'settings.onboardingRecommended': '권장',
  'settings.onboardingAmrCloudOfficialBadge': '공식',
  'settings.onboardingLocalTitle': '로컬 코딩 Agent',
  'settings.onboardingLocalBody': 'Claude Code, Codex, Cursor, Gemini 또는 OpenCode와 같이 설치된 CLI를 사용하세요.',
  'settings.onboardingLocalAction': 'CLI 설정 열기',
  'settings.onboardingCliScanHint': '보통 5~10초 정도 걸립니다.',
  'settings.onboardingByokTitle': '자체 키 사용',
  'settings.onboardingByokBody': '자체 모델 제공업체 인증 정보를 사용하세요.',
  'settings.onboardingByokAction': 'BYOK 설정 열기',
  'settings.onboardingDesignTitle': '디자인 시스템',
  'settings.onboardingDesignBody': '한 번 생성하여 어디서나 재사용하세요.',
  'settings.onboardingDesignIntroGenerateTitle': '기존 작업물에서 생성',
  'settings.onboardingDesignIntroGenerateBody': 'GitHub 또는 로컬 코드 저장소, Figma 파일, 이미지 및 기타 콘텐츠 자산에서 디자인 시스템을 업로드하세요.',
  'settings.onboardingDesignIntroReuseTitle': '이후 작업에서 재사용',
  'settings.onboardingDesignIntroReuseBody': '향후 프로토타입, 슬라이드 및 기타 콘텐츠에서 기존 글꼴, 간격, 로고 스타일, 색상 톤을 참조할 수 있습니다.',
  'settings.onboardingDesignIntroSkipTitle': '지금은 선택 사항',
  'settings.onboardingDesignIntroSkipBody': '디자인 시스템을 생성하지 않고 시작하려면 이 단계를 건너뛰세요.',
  'settings.onboardingGithubTitle': 'GitHub에서 가져오기',
  'settings.onboardingGithubBody': '프런트엔드 저장소를 사용하세요.',
  'settings.onboardingUploadTitle': '로컬 파일 업로드',
  'settings.onboardingUploadBody': '프로젝트 파일, 스크린샷, CSS, 문서 또는 자산을 추가하세요.',
  'settings.onboardingPromptTitle': '프롬프트로 생성',
  'settings.onboardingPromptBody': '제품 또는 브랜드를 설명하세요.',
  'settings.onboardingProfileTitle': '사용자 정보',
  'settings.onboardingProfileBody': '더 나은 기본값을 위한 선택 정보입니다.',
  'settings.onboardingRoleLabel': '역할',
  'settings.onboardingOrgSizeLabel': '조직 규모',
  'settings.onboardingUseCaseLabel': '사용 사례',
  ...
  'settings.onboardingOrgSolo': '개인 / 1인 (1명)',
  'settings.onboardingOrgTeam': '소규모 팀 (2-10명)',
  'settings.onboardingOrgStartup': '스타트업 / 중소기업 (11-50명)',
  'settings.onboardingOrgGrowth': '성장 기업 (51-200명)',
  'settings.onboardingOrgMidMarket': '중견 기업 (201-1000명)',
  'settings.onboardingOrgEnterprise': '대기업 (1000명 이상)',
  'settings.onboardingRolePm': '📋 제품 관리자',
  'settings.onboardingRoleDesigner': '🎨 디자이너',
  'settings.onboardingRoleEngineer': '💻 엔지니어',
  'settings.onboardingRoleMarketing': '📣 마케팅',
  'settings.onboardingRoleGrowth': '📈 그로스',
  'settings.onboardingRoleOps': '⚙️ 운영',
  'settings.onboardingRoleFounder': '🚀 창업자 / 임원',
  ...
  'settings.onboardingUseDeck': '🖥️ 프레젠테이션 / 덱',
  'settings.onboardingUseMarketing': '📈 마케팅 / 그로스',
  ...
  'settings.onboardingSourceSocial': '📱 소셜 미디어',
  'settings.onboardingSourceProductHunt': '🅿️ Product Hunt',
  'settings.onboardingSourceCommunity': '💬 디자인 / AI 커뮤니티',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 블로그 또는 뉴스레터',
  'settings.onboardingSourceAiTool': '✨ AI 도구 추천',
  'settings.onboardingSourceSearch': '🔍 검색',
  'settings.onboardingSourceEvent': '🎤 이벤트 또는 커뮤니티',
  'settings.onboardingBack': '뒤로',
  'settings.onboardingContinue': '계속',
  'settings.onboardingFinish': '설정 완료',
  'settings.onboardingSkip': '나중에 하기',
  'settings.kicker': '설정',
  ...
  'workingDirPicker.homeTitle': '이 프로젝트를 저장할 위치를 선택하세요',
  'workingDirPicker.processing': '처리 중…',
  'workingDirPicker.select': '폴더 선택',
  ...
  'home.openExistingProject': '기존 프로젝트 열기',
  'home.openExistingProjectOpening': '여는 중...',
  'home.chooseFolderSubtitle': '디스크에서 폴더를 선택하세요.',
  ...
  'skillPluginCandidate.createForMe': '대신 만들어 주기',
  'skillPluginCandidate.contributeToMain': 'main에 기여',
  'skillPluginCandidate.publishRepo': '저장소 게시',
  'skillPluginCandidate.dismiss': '닫기',
  ...
  'chat.designToolbox.tooltip': '디자인 도구상자 / 행운에 맡기기',
  'chat.designToolbox.aria': '디자인 도구상자 열기',
  'chat.designToolbox.lucky': '행운에 맡기기',
  ...
  'settings.memoryModelInlineHintCli': '선택 사항. 지원되는 경우 선택한 Local CLI를 사용합니다. 기본값을 재정의할 때만 모델을 선택하세요.',
  'settings.memoryModelInlineHintCliConstrained': '선택 사항. 지원되는 경우 선택한 Local CLI를 사용합니다. {provider}는 폴백 제공자 계열일 뿐입니다.',
