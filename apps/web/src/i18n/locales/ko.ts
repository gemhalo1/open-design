...
export const ko: Dict = {
  ...
  'chat.amrPreflight.body': '현재 사용 가능한 CLI 또는 API 키 모델 설정이 없습니다.',
  'chat.amrPreflight.recommend': 'AMR로 전환:',
  'chat.amrPreflight.chipNoConfig': '설정 없이 바로 사용',
  'chat.amrPreflight.chipOfficialAgents': 'Claude Code·Codex 공식 에이전트',
  'chat.amrPreflight.chipPayAsYouGo': '사용량 기반 과금',
  ...
  'chat.amrPreflight.meta': '로그인 및 충전 후 이 작업이 자동으로 전송됩니다.',
  ...
  'settings.testAgentSpawn': '{agentName}을(를) 시작할 수 없습니다. 설치 및 로그인 상태를 확인한 뒤 다시 테스트하세요.',
