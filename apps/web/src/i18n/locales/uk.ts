...
export const uk: Dict = {
  ...
  'chat.mode.design.summary': 'Для створення або зміни конкретних дизайн-результатів: сторінок, deck, dashboard, файлів і прототипів.',
  'chat.mode.design.solves': 'Використовуйте, коли Open Design має згенерувати файли, оновити workspace або перетворити brief на готовий результат.',
  'chat.mode.design.query1': 'Створи landing page запуску продукту з цього brief.',
  'chat.mode.design.query2': 'Зроби інвесторський deck на 10 слайдів із нотатками спікера.',
  'chat.mode.design.query3': 'Спроєктуй UI dashboard для цих метрик.',
