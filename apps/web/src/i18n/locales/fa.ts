...
export const fa: Dict = {
  ...
  'chat.amrPreflight.body': 'در حال حاضر هیچ پیکربندی مدل قابل استفاده‌ای از طریق CLI یا کلید API وجود ندارد.',
  'chat.amrPreflight.recommend': 'استفاده از AMR:',
  'chat.amrPreflight.chipNoConfig': 'بدون نیاز به پیکربندی',
  'chat.amrPreflight.chipOfficialAgents': 'ایجنت‌های رسمی Claude Code و Codex',
  'chat.amrPreflight.chipPayAsYouGo': 'پرداخت بر اساس مصرف',
  ...
  'chat.amrPreflight.meta': 'پس از ورود و شارژ حساب، این کار به‌طور خودکار ارسال می‌شود.',
  ...
  'settings.testAgentSpawn': '{agentName} اجرا نشد. از نصب و ورود به حساب مطمئن شوید و دوباره آزمایش کنید.',
