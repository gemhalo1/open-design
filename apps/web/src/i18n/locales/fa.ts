...
export const fa: Dict = {
  ...
  'settings.onboardingStepDesignSystem': 'سیستم طراحی',
  'settings.onboardingStepProfile': 'درباره شما',
  'settings.onboardingConnectTitle': 'انتخاب یک محیط اجرا',
  'settings.onboardingConnectBody': '',
  'settings.onboardingRecommended': 'پیشنهادی',
  'settings.onboardingAmrCloudOfficialBadge': 'رسمی',
  'settings.onboardingLocalTitle': 'Agent کدنویسی محلی',
  'settings.onboardingLocalBody': 'از یک CLI نصب‌شده مانند Claude Code، Codex، Cursor، Gemini یا OpenCode استفاده کنید.',
  'settings.onboardingLocalAction': 'باز کردن تنظیمات CLI',
  'settings.onboardingCliScanHint': 'این معمولاً ۵ تا ۱۰ ثانیه طول می‌کشد.',
  'settings.onboardingByokTitle': 'کلید خود را بیاورید',
  'settings.onboardingByokBody': 'از اعتبارنامه‌های ارائه‌دهنده مدل خودتان استفاده کنید.',
  'settings.onboardingByokAction': 'باز کردن تنظیمات BYOK',
  'settings.onboardingDesignTitle': 'سیستم طراحی',
  'settings.onboardingDesignBody': 'یک‌بار تولید کنید، همه‌جا استفاده کنید.',
  'settings.onboardingDesignIntroGenerateTitle': 'تولید از کار موجود',
  'settings.onboardingDesignIntroGenerateBody': 'سیستم طراحی خود را از GitHub یا مخازن کد محلی، فایل‌های Figma، تصاویر و سایر دارایی‌های محتوایی بارگذاری کنید.',
  'settings.onboardingDesignIntroReuseTitle': 'استفاده مجدد در کارهای آینده',
  'settings.onboardingDesignIntroReuseBody': 'پروتوتایپ‌ها، اسلایدها و سایر محتوای آینده می‌توانند به فونت‌ها، فاصله‌گذاری، سبک لوگو و رنگ‌بندی موجود شما ارجاع دهند.',
  'settings.onboardingDesignIntroSkipTitle': 'فعلاً اختیاری',
  'settings.onboardingDesignIntroSkipBody': 'اگر می‌خواهید بدون تولید سیستم طراحی شروع کنید، این مرحله را رد کنید.',
  'settings.onboardingGithubTitle': 'وارد کردن از GitHub',
  'settings.onboardingGithubBody': 'از یک مخزن فرانت‌اند استفاده کنید.',
  'settings.onboardingUploadTitle': 'بارگذاری فایل‌های محلی',
  'settings.onboardingUploadBody': 'فایل‌های پروژه، اسکرین‌شات‌ها، CSS، مستندات یا دارایی‌ها را اضافه کنید.',
  'settings.onboardingPromptTitle': 'تولید از روی پرامپت',
  'settings.onboardingPromptBody': 'محصول یا برند را توصیف کنید.',
  ...
  'settings.onboardingOrgSolo': 'تک‌نفره / شخصی (۱)',
  'settings.onboardingOrgTeam': 'تیم کوچک (۲ تا ۱۰)',
  'settings.onboardingOrgStartup': 'استارتاپ / کسب‌وکار کوچک (۱۱ تا ۵۰)',
  'settings.onboardingOrgGrowth': 'شرکت در حال رشد (۵۱ تا ۲۰۰)',
  'settings.onboardingOrgMidMarket': 'بازار میانی (۲۰۱ تا ۱۰۰۰)',
  'settings.onboardingOrgEnterprise': 'سازمانی (بیش از ۱۰۰۰)',
  ...
  'settings.onboardingRoleFounder': '🚀 بنیان‌گذار / مدیر اجرایی',
  ...
  'settings.onboardingUsePrototype': '📱 پروتوتایپ / رابط کاربری اپ',
  ...
  'settings.onboardingUseEngineering': '🤝 تحویل به تیم مهندسی',
  'settings.onboardingUseAgency': '💼 کار آژانسی / پروژه مشتری',
  'settings.onboardingSourceGithub': '🐙 GitHub',
  'settings.onboardingSourceFriend': '👥 دوست یا همکار',
  'settings.onboardingSourceSocial': '📱 شبکه‌های اجتماعی',
  'settings.onboardingSourceProductHunt': '🅿️ Product Hunt',
  'settings.onboardingSourceCommunity': '💬 جامعه طراحی / هوش مصنوعی',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 وبلاگ یا خبرنامه',
  'settings.onboardingSourceAiTool': '✨ پیشنهاد ابزار هوش مصنوعی',
  'settings.onboardingSourceSearch': '🔍 جستجو',
  'settings.onboardingSourceEvent': '🎤 رویداد یا جامعه',
  'settings.onboardingBack': 'بازگشت',
  'settings.onboardingContinue': 'ادامه',
  'settings.onboardingFinish': 'پایان راه‌اندازی',
  'settings.onboardingSkip': 'فعلاً رد شو',
  ...
  'workingDirPicker.homeTitle': 'محل قرارگیری این پروژه را انتخاب کنید',
  'workingDirPicker.processing': 'در حال پردازش…',
  'workingDirPicker.select': 'انتخاب پوشه',
  ...
  'home.openExistingProject': 'باز کردن پروژه موجود',
  'home.openExistingProjectOpening': 'در حال باز کردن...',
  'home.chooseFolderSubtitle': 'یک پوشه از دیسک خود انتخاب کنید.',
  ...
  'workspace.openFile': 'باز کردن یک فایل',
  'workspace.noFilesMatch': 'هیچ فایلی مطابقت ندارد',
  'workspace.allFiles': 'همه',
  'workspace.createNew': 'ایجاد مورد جدید',
  'workspace.tabOpen': 'باز کردن',
  'workspace.newSideChat': 'گفت‌وگوی جانبی جدید',
  'workspace.newSideChatDescription': 'باز کردن یک گفت‌وگوی آگاه از زمینه در زبانه جدید',
  'workspace.sideChatContextBanner': 'زمینه یکپارچه از گفت‌وگوی فعلی',
  'workspace.sideChatDefaultTitle': 'گفت‌وگوی جانبی',
  'workspace.newTerminal': 'ترمینال جدید',
  'workspace.newTerminalDescription': 'باز کردن یک پوسته در پوشه پروژه در زبانه جدید',
  'workspace.newBrowser': 'مرورگر جدید',
  'workspace.newBrowserDescription': 'باز کردن یک زبانه مرورگر داخلی برای سایت‌های مرجع و پژوهش طراحی',
  ...
  'settings.memoryModelInlineLabel': 'مدل حافظه',
  'settings.memoryModelInlineSameAsChat': 'مانند چت',
  'settings.memoryModelInlineSameAsChatWithModel': 'مانند چت ({model})',
  'settings.memoryModelInlineSameAsChatWithProvider': 'مانند چت ({provider})',
  'settings.memoryModelInlineHintCli': 'اختیاری. در صورت پشتیبانی از CLI محلی انتخاب‌شده استفاده می‌کند؛ مدلی را فقط برای جایگزینی مقدار پیش‌فرض انتخاب کنید.',
  'settings.memoryModelInlineHintCliConstrained': 'اختیاری. در صورت پشتیبانی از CLI محلی انتخاب‌شده استفاده می‌کند؛ {provider} تنها خانوادهٔ ارائه‌دهندهٔ جایگزین است.',
  ...
  'settings.memoryModelInlineFlashSaved': 'ذخیره شد',
  'settings.memoryModelInlineFlashCleared': 'پاک شد',
