...
export const fa: Dict = {
  ...
  'settings.amrActivationHint': 'در حال باز کردن مرورگر… باز نشد؟ برای تکمیل ورود از پیوند زیر استفاده کنید.',
  ...
  'settings.amrActivationCopyCode': 'کپی کد تأیید',
  'settings.amrActivationCopy': 'کپی',
  'settings.amrActivationCopied': 'کپی شد',
  ...
  'onboarding.buildArtifacts': 'پروتوتایپ·اسلاید·PDF·رزومه·داشبورد·کارت بازاریابی',
