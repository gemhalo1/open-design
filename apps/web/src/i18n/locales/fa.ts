...
export const fa: Dict = {
  ...
  'chat.mode.design.summary': 'برای ساخت یا تغییر خروجی های طراحی مشخص مثل صفحه، deck، داشبورد، فایل و پروتوتایپ.',
  'chat.mode.design.solves': 'وقتی می خواهید Open Design فایل بسازد، workspace را به روز کند یا brief را به خروجی قابل تحویل تبدیل کند استفاده کنید.',
  'chat.mode.design.query1': 'از این brief یک صفحه فرود برای لانچ محصول بساز.',
  'chat.mode.design.query2': 'یک deck سرمایه گذاری ۱۰ اسلایدی با یادداشت ارائه بساز.',
  'chat.mode.design.query3': 'برای این متریک ها UI داشبورد طراحی کن.',
